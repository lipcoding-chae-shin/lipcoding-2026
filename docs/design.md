...
> **출처**: [getdesign.md](https://getdesign.md/linear.app/design-md) · VoltAgent [awesome-design-md](https://github.com/VoltAgent/awesome-design-md) 컬렉션의 `design-md/linear.app/DESIGN.md`.
> Linear(linear.app)를 분석한 production-grade 디자인 레퍼런스로, 코딩 에이전트의 UI 생성 기준으로 사용한다.
